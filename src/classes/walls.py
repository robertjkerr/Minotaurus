...
class walls:
    ...
    def checkWall1(self):
        ...
        if self.grid[p[1]][p[0]]!=0 or self.movingWall!=None:
            return
    ...
    def moveWall(self):
        if self.controller.dice!='Wall' \
            or _mapTools.mousePos()[0]>=33 \
            or _mapTools.mousePos()[1]>=33 \
            or self.controller.turn()[1].moveReady!=True:
            return
